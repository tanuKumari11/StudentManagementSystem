...
router.get('/requests', [ensureAuthenticated, readAccessControl], async (req, res) => {
...
router.put('/requests/:id', [ensureAuthenticated, updateAccessControl], async (req, res) => {
...
router.delete('/requests/:id', [ensureAuthenticated, deleteAccessControl], async (req, res) => {
    try {
        const result = await User.remove({
            _id: req.params.id
        });
...
router.get('/edit/:id', [ensureAuthenticated, updateAccessControl], async (req, res) => {
...
router.put('/edit/:id', [ensureAuthenticated, updateAccessControl], async (req, res) => {
